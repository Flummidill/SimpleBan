...
public class JoinListener implements Listener {
    ...
    public JoinListener(SimpleBan plugin, BanManager manager) {
        this.plugin = plugin;
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (sendUpdateNotification && player.hasPermission("simpleban.admin")) {
            // Prefix
            ...
            TextComponent prefixPart3 = new TextComponent("Ban");
            ...
            Text2.setClickEvent(new ClickEvent(
                ...
                "https://github.com/Flummidill/SimpleBan/releases/latest"
            ));
